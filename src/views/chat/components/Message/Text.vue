    ...
    <div ref="textRef" class="leading-relaxed break-words">
      <div v-if="!inversion">
        <template v-if="!asRawText">
          <div class="flex">
            <div @click="changeShowReasoning" class="reasoning-toggle h-32px px-10px mb-10px leading-32px rounded-8px cursor-pointer">已深度思考</div>
          </div>
          <div
            v-if="reasoningVal && showReasoning"
            class="markdown-body reasoning-content pl-13px border-l mb-10px"
            v-html="reasoningVal" />
...
const wrapClass = computed(() => {
  return [
    ...
    'rounded-md',
    'px-3 py-2',
    props.inversion ? 'message-user' : 'message-ai',
